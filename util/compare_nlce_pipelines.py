...
4. Update fitting scripts:
   ------------------------
   OLD: python util/nlc_fit.py ...
   NEW: python util/nlc_fit_ftlm.py ...
...
Try FTLM with a small example:
  ...
  python util/nlce_ftlm.py --max_order 3 --ftlm_samples 20 --parallel
...
For more details, see:
  - util/README_NLCE_FTLM.md (comprehensive guide)
